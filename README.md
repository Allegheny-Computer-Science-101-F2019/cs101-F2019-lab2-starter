...
textbook, paying close attention to Section 1.3 through 1.9 and project P-1.26
at the end of Chapter 1. Please see the course instructor or one of the student
...
```
git remote add download git@github.com:Allegheny-Computer-Science-101-F2019/cs101-F2019-lab2-starter.git
```
...
2](https://github.com/Allegheny-Computer-Science-101-F2019/cs101-F2019-lab2-starter)
repository and [raise an
issue](https://github.com/Allegheny-Computer-Science-101-F2019/cs101-F2019-lab2-starter/issues).
